...
public class RobotMap {
    ...
    public final class DriveBaseModes {
        public static final int SPEED_CONTROL_MODE = 0;
        public static final int POSITION_MODE = 1;
    }

    //TALON IDS
    public final class TalonIDs {
    ...
    public final class Constants {
        ...
        public static final double INTAKE_PIVOT_VERTICAL_POSITION = 1750; //1750 for normal position, 1950 for home peg
        public static final double INTAKE_PIVOT_GEARINTAKE_POSITION = 3845;
        public static final double INTAKE_PIVOT_SPIT_POSITION = INTAKE_PIVOT_GEARINTAKE_POSITION - 400;
    ...
    public final class GamepadPorts {
